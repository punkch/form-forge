...
| # | Steps | Expected |
|---|---|---|
| 1 | Create forms "Alpha" and "Beta"; give Alpha a CSV attachment. Library → overflow menu → Export workspace | A `workspace-<date>.odkbuilder.zip` downloads |
...
| 6 | Row menu on Alpha → Export form archive | `alpha.odkbuilder.zip` with a single-form manifest; importing it elsewhere restores Alpha losslessly |
